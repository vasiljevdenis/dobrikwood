...
class OrderController extends Controller
{
    ...
    public function newOrder(Request $request)
    {
        $id = DB::table('orders')->insertGetId([
            ...
            'nameSecond' => $request->has('recipient') ? $request->input('recipient')->nameSecond : '',
            'lastNameSecond' => $request->has('recipient') ? $request->input('recipient')->lastNameSecond : '',
            'phoneSecond' => $request->has('recipient') ? $request->input('recipient')->phoneSecond : '',
